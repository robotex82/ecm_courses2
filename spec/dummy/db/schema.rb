...
ActiveRecord::Schema.define(version: 20170226142516) do
  ...
  add_index "ecm_courses_courses", ["course_category_id"], name: "index_ecm_courses_courses_on_course_category_id"
